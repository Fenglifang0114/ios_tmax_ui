...
themeColor(Map<String, dynamic> colorTheme) {
  return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        surface: Color(int.parse(colorTheme['background'])),
        ...
        // background: Color.fromARGB(255, 239, 243, 246), //0xFFEFF3F6
        ...
        primaryContainer: Color.fromARGB(255, 251, 253, 248), //0xFFF8F9FD
        scrim: Color.fromARGB(255, 222, 239, 204), //0xCCE0EF
