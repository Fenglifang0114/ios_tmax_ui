...
class MobileDataPage extends StatefulWidget {
  ...
  const MobileDataPage({super.key, required this.onNavigate, this.lastRouteName});
...
class _MobileDataPageState extends State<MobileDataPage> {
  ...
  void _loadMenus() {
    ...
    final settingGroup = hierarchicalMenus.firstWhere(
      (group) => group.title == (localizedStrings?.menuData ?? "menuData"),
        ...
        itemBuilder: (context, index) {
          ...
          return MouseRegion(
            ...
            child: GestureDetector(
              ...
              onTap: () {
                writelog("[MOBILE_DATA] Tapped menu item: ${menu.title}, route: ${menu.routeName}");
