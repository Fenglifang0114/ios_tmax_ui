...
class MobileFormatPage extends StatefulWidget {
  ...
  const MobileFormatPage({super.key, required this.onNavigate, this.lastRouteName});

  @override
  State<MobileFormatPage> createState() => _MobileFormatPageState();
}

class _MobileFormatPageState extends State<MobileFormatPage> {
  ...
  void _loadMenus() {
    ...
    final settingGroup = hierarchicalMenus.firstWhere(
      (group) => group.title == (localizedStrings?.menuFormat ?? "menuFormat"),
