...
//       if (cell != null && cell.value != null) {
//         String head = cell.value.toString();
//         head = head.replaceAll(" ", "");
//         head = head.replaceAll("*", "");
//         head = head.toLowerCase();
//         headers.add(head);
